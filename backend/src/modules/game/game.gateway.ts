...
export class GameGateway {
  ...
  lobbySendInvitGame(client: any, data : {idTarget : number, type : string, nameTarget: string}) : void {
    this.lobbyService.lobbySendInvitGame(client, data.idTarget, data.type, data.nameTarget);
  }
