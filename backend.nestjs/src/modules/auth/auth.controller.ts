import { Controller, Get, Post, Delete, Body, Req, Request, Res, Response, UseGuards } from "@nestjs/common";
...
export class AuthController {
	...
	@Post('2fa/validate')
	twoFactorValidate() { return { message: `Successfully logged using 2FA` } }
